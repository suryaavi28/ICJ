...
import com.pages.icj.ICJ_UAT_ClaimsPage;
import com.pages.icj.ICJ_UAT_DashBoardPage;
	...
	public class ICJ_UAT_ClaimsPageTest extends TestBase_ICJ{
		...
		ICJ_UAT_ClaimsPage icjuatclaimsppage;
		...
		public void preBase() throws InterruptedException {
			...
			waitUtils.waitForPageToLoad(driver, 1);
			icjuatclaimsppage = icjuatsubscriptiondetailpage.clickOnTheClaime();
		}
		...
		public void testWithSubscriptiondetailform() throws InterruptedException {
			icjuatclaimsppage.enterAllTheClaimDetails();
		}
